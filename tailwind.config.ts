...
extend: {
      colors: {
        ...
        game: {
          ...
          platinum: "hsl(var(--game-platinum))",
        },
        house: {
          serenity: "hsl(var(--house-serenity))",
          mindful: "hsl(var(--house-mindful))",
          harmony: "hsl(var(--house-harmony))",
          balance: "hsl(var(--house-balance))",
        },
        status: {
