  ...
  return (
    <div className="min-h-screen bg-gradient-hero relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-wellness-peace/30 rounded-full blur-3xl animate-float" style={{ animationDelay: '-2s' }} />
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
        ...
        >
          ...
          >
            Your anonymous, safe space for mental wellness. Connect, learn, and grow with AI-powered support and peer community.
          </motion.p>
        ...
        >
          <p className="text-muted-foreground mb-4">Trusted by students across India</p>
          <div className="flex justify-center items-center space-x-8 opacity-60">
            <div className="text-sm">🎓 50+ Universities</div>
            <div className="text-sm">🛡️ HIPAA Compliant</div>
            <div className="text-sm">🌍 5 Languages</div>
